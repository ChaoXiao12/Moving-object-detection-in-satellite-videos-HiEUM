...
from lib.Trainer.base_trainer_normal import BaseTrainer
import cv2
...
class CtdetTrainer_normal(BaseTrainer):
    def __init__(self, opt, model, optimizer=None):
        super(CtdetTrainer_normal, self).__init__(opt, model, optimizer=optimizer)
